          ...
          <form  onSubmit={submitForm}>
            ...
            <div className="time_container">
                ...
                <label for="firstname">First Name</label><br/>
                 <input value={firstname} onChange={(e)=>setFirstname(e.target.value)} type="text" id="firstname" name="firstname" placeholder="Enter your first name" required/>
                </div>
<br/>
                <div className="time_name">
                <label for="lastname">Last Name</label><br/>
                 <input value={lastname} onChange={(e)=>setLastname(e.target.value)} type="text" id="lastname" name="lastname" placeholder="Enter your last name" required/>
                </div>
            </div>
<br/>
            <div className="time_container_right">
                ...
                <span
                 ...
                 <input  value={phone} 	pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" onChange={(e)=>setPhone(e.target.value)}  type="phone" id="number" name="number" placeholder="Enter your contact number" required />
                </div>
<br/>
                <div className="time_based">
                <label for="based">Where are you based?</label><br/>
                 <input  value={based} onChange={(e)=>setBased(e.target.value)}  type="text" id="based" name="based" placeholder="Enter the city name" required/>
                </div>
